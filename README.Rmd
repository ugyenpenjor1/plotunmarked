...
The goal of <strong>plotunmarked</strong> is to provide convenient plotting functions for visualising predictions from unmarked models, particularly occupancy estimates – a quick and dirty approach!
